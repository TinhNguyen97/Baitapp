                                            ...
                                            @foreach ($allProducts as $key => $item)
                                                <tr>
                                                    ...
                                                    <td class="d-none d-xl-table-cell" style="text-align: center">
                                                        {{ $item->description }}</td>
                                                    @if ($item->is_active)
                                                        <td class="d-none d-xl-table-cell" style="text-align: center">Đã
                                                            kích hoạt</td>
                                                    @else
                                                        <td class="d-none d-xl-table-cell" style="text-align: center">Chưa
                                                            kích hoạt</td>
                                                    @endif
                                                    <td class="d-none d-xl-table-cell" style="text-align: center">
                                                        {{ $item->created_at }}</td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="editPromotionPrice" class="form-control" placeholder="Nhập giá"
                        ...
                        <div class="modal-footer justify-content-between" id="edit-form">
                            ...
                            <button class="btn btn-primary" type="button" onclick="$('#form-edit').submit()"
                                class="close" name="update">Chỉnh sửa</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
