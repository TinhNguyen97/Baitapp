...
include '../DB/maxDiscount.php';
include '../DB/newest.php';
include '../DB/topsale.php';
...
<body>
        ...
        <div class="row border-top px-xl-5">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 1;">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        <?php foreach ($result2 as $key => $row) : ?>
                            <a href="" class="nav-item nav-link"><?= $row['name'] ?></a>
                        <?php endforeach; ?>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    <a href="store.php" class="text-decoration-none d-block d-lg-none">
                        <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">E</span>Shopper</h1>
                    </a>
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-12">
                <img src="../image/Anh-do-an-burger.jpg" width="430vw" height="1500vh">
                <!-- Size End -->
            </div>
            <!-- Shop Sidebar End -->
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                            <div class="card product-item border-0 mb-4">
                                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="w-100" src="<?= $row['image'] ?>" alt="" height="500px" width="50px">
                                </div>
                                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                    <h6 class="text-truncate mb-3"><?= $row['name'] ?></h6>
                                    <div class="d-flex justify-content-center">
                                        <h6><?= '$' . $row['price_after_sale'] ?></h6>
    ...
    <div class="container-fluid py-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Top Sale</span></h2>
        </div>
        <div class="row px-xl-5">
            <div class="col">

                <div class="owl-carousel related-carousel">
                    <?php foreach ($resultTopSale as $key => $row) : ?>
    ...
    <div class="container-fluid py-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Newest</span></h2>
        </div>
        <div class="row px-xl-5">
            <div class="col">

                <div class="owl-carousel related-carousel">
                    <?php foreach ($resultNewest as $key => $row) : ?>
                        <div class="card product-item border-0">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="w-100" src="<?= $row['image'] ?>" alt="" height="500px" width="50px">
                            </div>
    ...
    <div class="container-fluid py-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Top Discount</span></h2>
        </div>
        <div class="row px-xl-5">
            <div class="col">

                <div class="owl-carousel related-carousel">
                    <?php foreach ($maxDiscount as $key => $row) : ?>
                        <div class="card product-item border-0">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="w-100" src="<?= $row['image'] ?>" alt="" height="500px" width="50px">
                            </div>
